...
signalTower.addSignal( 'slideRequested', 2 );
signalTower.addSignal( 'windowFocusChanged', 2 );

// Example of adding a signal and immediately setting its payload
signalTower.addSignal( 'colorArrayChanged' )
  .dispatch( [ 'red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet' ] );
